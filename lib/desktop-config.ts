...
export const ICONS: Record<IconId, IconMeta> = {
  ...
  notes: { id: "notes", label: "备忘录", tone: "var(--c-icon-amber)", placeholder: false },
  ...
  settings: { id: "settings", label: "设置", tone: "var(--c-icon-slate)", placeholder: false, hideInPhoneCheck: true },
  theme: { id: "theme", label: "\u4E3B\u9898", tone: "var(--c-icon-violet)", placeholder: true, hideInPhoneCheck: true },
  resources: { id: "resources", label: "\u8D44\u6E90\u5E93", tone: "var(--c-icon-teal)", placeholder: false, hideInPhoneCheck: true },
  resource_hub: { id: "resource_hub", label: "资源集市", tone: "var(--c-icon-amber)", placeholder: false, hideInPhoneCheck: true },
  characters: {
    id: "characters",
    label: "\u89D2\u8272",
  ...
  qa: { id: "qa", label: "工坊", tone: "var(--c-icon-qa, #4a505c99)", placeholder: false, hideInPhoneCheck: true },
  appmarket: { id: "appmarket", label: "应用市场", tone: "var(--c-icon-teal)", placeholder: false, hideInPhoneCheck: true },
};
